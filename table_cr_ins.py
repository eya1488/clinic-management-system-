...
def add_appointment(patient_name, doctor_name, appointment_date, appointment_time):
    try:
        conn = connect_db()
        cursor = conn.cursor()

        cursor.execute("""
            INSERT INTO appointments (patient_name, doctor_name, appointment_date, appointment_time, availability)
            VALUES (%s, %s, %s, %s, %s)
        """, (patient_name, doctor_name, appointment_date, appointment_time, True))
        conn.commit()
...
def update_appointment(appointment_id, patient_name, doctor_name, appointment_date, appointment_time):
    try:
        conn = connect_db()
        cursor = conn.cursor()
